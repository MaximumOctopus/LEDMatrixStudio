...
static const std::wstring __LEDStudioDate = L"March 5th 2024";

#if _WIN64
static const std::wstring __LEDStudioVersion = L"0.20.20 (x64)";
#else
static const std::wstring __LEDStudioVersion = L"0.20.20 (x32)";
#endif
