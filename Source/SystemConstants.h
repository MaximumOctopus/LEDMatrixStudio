...
static const std::wstring __LEDStudioDate = L"January 22nd 2024";

#if _WIN64
static const std::wstring __LEDStudioVersion = L"0.20.08 (x64)";
#else
static const std::wstring __LEDStudioVersion = L"0.20.08 (x32)";
#endif
