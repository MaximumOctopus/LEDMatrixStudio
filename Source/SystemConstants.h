...
static const std::wstring __LEDStudioDate = L"December 11th 2023";

#if _WIN64
static const std::wstring __LEDStudioVersion = L"0.20.01 (x64)";
#else
static const std::wstring __LEDStudioVersion = L"0.20.01 (x32)";
#endif
