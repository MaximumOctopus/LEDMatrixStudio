...
static const std::wstring __LEDStudioDate = L"March 17th 2024";

#if _WIN64
static const std::wstring __LEDStudioVersion = L"0.20.22 (x64)";
#else
static const std::wstring __LEDStudioVersion = L"0.20.22 (x32)";
#endif
