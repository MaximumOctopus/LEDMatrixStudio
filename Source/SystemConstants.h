...
static const std::wstring __LEDStudioDate = L"June 23rd 2024";

#if _WIN64
static const std::wstring __LEDStudioVersion = L"0.20.23 (x64)";
#else
static const std::wstring __LEDStudioVersion = L"0.20.23 (x32)";
#endif
