...
static const std::wstring __LEDStudioDate = L"February 6th 2024";

#if _WIN64
static const std::wstring __LEDStudioVersion = L"0.20.10 (x64)";
#else
static const std::wstring __LEDStudioVersion = L"0.20.10 (x32)";
#endif
