...
static const std::wstring __LEDStudioDate = L"December 17th 2023";

#if _WIN64
static const std::wstring __LEDStudioVersion = L"0.20.02 (x64)";
#else
static const std::wstring __LEDStudioVersion = L"0.20.02 (x32)";
#endif
